...
mod_df <- as.data.frame(samples)
ggplot(data = mod_df) + geom_density(aes(x = priorfrac.b), fill = "blue", alpha = 0.25) + geom_vline(xintercept = median.b1, color = "black") + geom_vline(xintercept = cred.int[1], color = "green3") + geom_vline(xintercept = cred.int[2], color = "green3") + ggtitle("Log-Odds Scale")
```
