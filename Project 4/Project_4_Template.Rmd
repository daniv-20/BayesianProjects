...
`r signif(pprb,3)*100`% of the confidence interval is on one side of zero, so we can say that there is strong evidence of an interaction between age and prior history of fracture, even if the effect is small.
