...
t = data.frame(Input = c("N", "SampleSize", "Theta.test (vector)", "Alpha.prior", "Beta.prior", "Theta.success"), 
               Description = c("Number of Simulations", "Number of participants in simulated study", "A vector containign a range of possible \u03B8 values.", "A vector containing the alpha values of the priors", "A vector containing the beta values of the priors", "The success criterion"), 
...
The program will output a table, with columns as described in the table below. 
...
For each value of theta in theta test: 
  1. Use rbinom() with N, Sample Size and theta to get a vector of N simulated Y values where Y is the number of simulated successes.
