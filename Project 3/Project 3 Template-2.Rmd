...
The normal-normal family of Bayesian models uses a Gaussian distribution to represent both the prior and likelihood functions. This family is well-suited to modeling continuous data, particularly where there are no upper or lower bounds on the values the data or parameter can take on. 
