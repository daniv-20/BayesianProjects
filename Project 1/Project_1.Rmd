---
title: "Bayes Project 1"
author: "Suz Angermeier"
date: "2024-03-12"
output: pdf_document
---
...
Revisit your futility rule in question 2. This time, instead of assuming a Beta(1,1) prior try tuning a prior for the analysis based on the following results from a hypothetical series of Phase I trials of the
...
table4 = flextable(tbl2) %>%
  colformat_double(j = c(2), digits = 3) %>%
  set_header_labels(n.resp = "Number of Responses Observed", post = "Posterior Probability of Suboptimal Response \n < 55%", obs = "Observed Response Probability", fut = "Treatment is Futile?"); table4
```
...
b) State the hyperparameters of your selected prior and explain what information is contained in these hyperparameters.  

The hyperparameters of our selected prior is Beta(`r {round(a5,3)}`, `r {round(b5,3)}`).  

c) Make a plot of the prior and explain what you see in non-technical language. Your answer should be framed in terms of the possible values for the response to treatment.  
...
e) Is there any information about your posterior distribution that you know just by looking at this prior?  
